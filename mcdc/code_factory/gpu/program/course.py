...
def step(program: nb.uintp, particle_input: interface.particle_gpu):
    ...
    if particle["event"] == EVENT_LOST:
        ...
        if particle["particle_type"] == PARTICLE_NEUTRON:
            neutron_interface.collision(particle_container, collision_data_container, program, data)
            return
        elif particle["particle_type"] == PARTICLE_ELECTRON:
            electron_interface.collision(particle_container, collision_data_container, program, data)
            return
...
def electron_collision_intercept(particle_container, collision_data_container, program, data):
...
def neutron_collision_intercept(particle_container, collision_data_container, program, data):
